...
class HelloWorkSpider(scrapy.Spider):
    ...
    NB_pages = 61
    start_urls = [
        'https://www.hellowork.com/fr-fr/emploi/recherche.html?k=Intelligence+artificielle&l=France&l_autocomplete=http%3A%2F%2Fwww.rj.com%2Fcommun%2Flocalite%2Fpays%2FFR&ray=20&d=all&c=CDI&c=CDD&c=Travail_temp&p={}&mode=scroll/'.format(i) for i in range(1, NB_pages)]
...
filename = "jobs_intelligence_france.json"

if filename in os.listdir("/Users/leenaomrani/Desktop/final-project/jobs_intelligence_artficielle_france"):
    os.remove(
        "/Users/leenaomrani/Desktop/final-project/jobs_intelligence_artficielle_france" + filename)
