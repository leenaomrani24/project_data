...
file = open('/Users/leenaomrani/Desktop/final-project/jobs_intelligence_artficielle_france/jobs_intelligence_france.json')
...
class HelloWorkSpiderDetail(scrapy.Spider) :
    ...
    def parse(self, response):
        ...
        yield {
            ...
            "tags_secteur": response.xpath('/html/body/main/section[1]/section[3]/ul[2]/li[1]/text()').getall(),
            "tags_secteur1": response.xpath('/html/body/main/section[1]/section[4]/ul[2]/li[1]/text()').getall(),
            "tags_secteur2": response.xpath('/html/body/main/section[1]/section[5]/ul[2]/li[1]/text()').getall(),
            "tags_education": response.xpath('/html/body/main/section[1]/section[3]/ul[2]/li[2]/text()').getall(),
            "tags_education2": response.xpath('/html/body/main/section[1]/section[3]/ul[2]/li[3]/text()').getall()
            }

            
filename = "jobs_intelligence_tags.json"

if filename in os.listdir("/Users/leenaomrani/Desktop/final-project/jobs_intelligence_artficielle_france/") : 
    os.remove("/Users/leenaomrani/Desktop/final-project/jobs_intelligence_artficielle_france/" + filename) 

process = CrawlerProcess(settings = {
    'USER_AGENT':    'Chrome/110.0.5481.178',
    'LOG_LEVEL': logging.INFO,
    "FEEDS": {'/Users/leenaomrani/Desktop/final-project/jobs_intelligence_artficielle_france/'+ filename : {"format": "json"},
    }
})
