...
file = open(
    "/Users/leenaomrani/Desktop/final-project/01_HW_Jobs_data_France.json")
result = json.load(file)
list_url = ["https://www.hellowork.com" + elt["url"]
            for elt in result]  # formatage des urls complètes


class HelloWorkSpiderDetail(scrapy.Spider):

    name = "HelloWorkJobs_Data_Details"
...
filename = "all_data_France_tags.json"
