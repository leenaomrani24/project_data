...
file = open("/Users/leenaomrani/Desktop/final-project/merged_all_jobs.json")
...
class HelloWorkSpiderDetail(scrapy.Spider) :
    ...
    def parse(self, response):
        ...
        yield {
            ...
            "tags_secteur" : response.xpath('/html/body/main/section[1]/section[4]/ul[2]/li[1]/text()').getall(),
            "tags_education": response.xpath('/html/body/main/section[1]/section[4]/ul[2]/li[2]/text()').getall()
            }

            
filename = "all_jobs_secteur_tags.json"

if filename in os.listdir("/Users/leenaomrani/Desktop/final-project/") : 
    os.remove("/Users/leenaomrani/Desktop/final-project/" + filename) 

process = CrawlerProcess(settings = {
    'USER_AGENT':    'Chrome/110.0.5481.178',
    'LOG_LEVEL': logging.INFO,
    "FEEDS": {'/Users/leenaomrani/Desktop/final-project/'+ filename : {"format": "json"},
    }
})
